...
func initNetworkinstanceProtocolsLdpPeersTcptransport(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"authentication": initNetworkinstanceProtocolsLdpPeersTcptransportAuthentication,
	}
	e := &yentry.Entry{
		Name:             "tcp-transport",
		Key:              []string{},
