...
func SetupSystemNetworkinstanceProtocolsBgpvpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	...
	SystemNetworkinstanceProtocolsBgpvpnHandler := &EnqueueRequestForAllSystemNetworkinstanceProtocolsBgpvpn{
	...
	return srlv1alpha1.SystemNetworkinstanceProtocolsBgpvpnGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn{}}, SystemNetworkinstanceProtocolsBgpvpnHandler).
		Watches(&source.Channel{Source: events}, SystemNetworkinstanceProtocolsBgpvpnHandler).
		Complete(r)
}
...
func initYangSystemNetworkinstanceProtocolsBgpvpn(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
...
func (v *validatorSystemNetworkinstanceProtocolsBgpvpn) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsBgpvpn)
	}
...
func (e *externalSystemNetworkinstanceProtocolsBgpvpn) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return errors.New(errUnexpectedSystemNetworkinstanceProtocolsBgpvpn)
	}
...
func (e *externalSystemNetworkinstanceProtocolsBgpvpn) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
