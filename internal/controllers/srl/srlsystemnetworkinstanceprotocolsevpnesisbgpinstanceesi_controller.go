...
const (
	// Errors
	errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi       = "the managed resource is not a SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi resource"
	errKubeUpdateFailedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi = "cannot update SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi"
	errReadSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi             = "cannot read SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi"
	...
	errUpdateSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi           = "cannot update SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi"
...
func SetupSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiGroupKind)

	events := make(chan cevent.GenericEvent)

	y := initYangSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiGroupVersionKind),
		managed.WithPollInterval(nddcopts.Poll),
		managed.WithExternalConnecter(&connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{
			log:          nddcopts.Logger,
			kube:         mgr.GetClient(),
		...
		managed.WithValidator(&validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiHandler := &EnqueueRequestForAllSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{
	...
	return srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{}).
		Owns(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{}}, SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiHandler).
		Watches(&source.Channel{Source: events}, SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsiHandler).
		Complete(r)
}
...
func initYangSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{&yresource.Resource{
...
func (r *SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if !ok {
...
func (r *SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
type validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi struct {
	log          logging.Logger
	deviceSchema *yentry.Entry
	y            yresource.Handler
}

func (v *validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	}
	d, err := json.Marshal(&cr.Spec.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if err != nil {
...
func (v *validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) ValidateParentDependency(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateParentDependencyObservation, error) {
	log := v.log.WithValues("resource", mg.GetName())
...
func (v *validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) ValidateResourceIndexes(ctx context.Context, mg resource.Managed) (managed.ValidateResourceIndexesObservation, error) {
	//log := v.log.WithValues("resource", mg.GetName())
...
// is called.
type connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi struct {
	log          logging.Logger
	kube         client.Client
...
func (c *connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	log := c.log.WithValues("resource", mg.GetName())
	//log.Debug("Connect")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if !ok {
		return nil, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	}
	...
	return &externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}

// An ExternalClient observes, then either creates, updates, or deletes an
// external resource to ensure it reflects the managed resource's desired state.
type externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi struct {
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Close() {
	e.client.Close()
}

func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Observing ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if !ok {
		return managed.ExternalObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	if !ok {
		return errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) Delete(ctx context.Context, mg resource.Managed) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Deleting ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) GetTarget() []string {
	return e.targets
}

func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstanceEsi) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
