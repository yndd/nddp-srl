...
const (
	...
	errUpdateRoutingpolicyAspathset           = "cannot update RoutingpolicyAspathset"
...
func SetupRoutingpolicyAspathset(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	...
	y := initYangRoutingpolicyAspathset(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.RoutingpolicyAspathsetGroupVersionKind),
		...
		managed.WithValidator(&validatorRoutingpolicyAspathset{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
...
func initYangRoutingpolicyAspathset(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &RoutingpolicyAspathset{&yresource.Resource{
...
func (r *RoutingpolicyAspathset) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlRoutingpolicyAspathset)
	if !ok {
...
func (r *RoutingpolicyAspathset) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
func (v *validatorRoutingpolicyAspathset) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlRoutingpolicyAspathset)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedRoutingpolicyAspathset)
	}
	d, err := json.Marshal(&cr.Spec.RoutingpolicyAspathset)
	if err != nil {
...
func (c *connectorRoutingpolicyAspathset) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	return &externalRoutingpolicyAspathset{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}
...
func (e *externalRoutingpolicyAspathset) Close() {
	e.client.Close()
}
...
func (e *externalRoutingpolicyAspathset) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")
...
func (e *externalRoutingpolicyAspathset) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalRoutingpolicyAspathset) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalRoutingpolicyAspathset) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
