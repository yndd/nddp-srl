...
const (
	// Errors
	errUnexpectedSystemNetworkinstanceProtocolsEvpn       = "the managed resource is not a SystemNetworkinstanceProtocolsEvpn resource"
	errKubeUpdateFailedSystemNetworkinstanceProtocolsEvpn = "cannot update SystemNetworkinstanceProtocolsEvpn"
	errReadSystemNetworkinstanceProtocolsEvpn             = "cannot read SystemNetworkinstanceProtocolsEvpn"
	errCreateSystemNetworkinstanceProtocolsEvpn           = "cannot create SystemNetworkinstanceProtocolsEvpn"
	errUpdateSystemNetworkinstanceProtocolsEvpn           = "cannot update SystemNetworkinstanceProtocolsEvpn"
...
func SetupSystemNetworkinstanceProtocolsEvpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupSystemNetworkinstanceProtocolsEvpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnGroupKind)

	events := make(chan cevent.GenericEvent)

	y := initYangSystemNetworkinstanceProtocolsEvpn(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnGroupVersionKind),
		managed.WithPollInterval(nddcopts.Poll),
		managed.WithExternalConnecter(&connectorSystemNetworkinstanceProtocolsEvpn{
			log:          nddcopts.Logger,
			kube:         mgr.GetClient(),
		...
		managed.WithValidator(&validatorSystemNetworkinstanceProtocolsEvpn{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("SystemNetworkinstanceProtocolsEvpn-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	SystemNetworkinstanceProtocolsEvpnHandler := &EnqueueRequestForAllSystemNetworkinstanceProtocolsEvpn{
	...
	return srlv1alpha1.SystemNetworkinstanceProtocolsEvpnGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn{}).
		Owns(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn{}}, SystemNetworkinstanceProtocolsEvpnHandler).
		Watches(&source.Channel{Source: events}, SystemNetworkinstanceProtocolsEvpnHandler).
		Complete(r)
}
...
func initYangSystemNetworkinstanceProtocolsEvpn(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &SystemNetworkinstanceProtocolsEvpn{&yresource.Resource{
...
func (r *SystemNetworkinstanceProtocolsEvpn) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn)
	if !ok {
...
func (r *SystemNetworkinstanceProtocolsEvpn) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
func (v *validatorSystemNetworkinstanceProtocolsEvpn) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpn)
	}
	d, err := json.Marshal(&cr.Spec.SystemNetworkinstanceProtocolsEvpn)
	if err != nil {
...
func (v *validatorSystemNetworkinstanceProtocolsEvpn) ValidateParentDependency(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateParentDependencyObservation, error) {
	log := v.log.WithValues("resource", mg.GetName())
...
func (v *validatorSystemNetworkinstanceProtocolsEvpn) ValidateResourceIndexes(ctx context.Context, mg resource.Managed) (managed.ValidateResourceIndexesObservation, error) {
	//log := v.log.WithValues("resource", mg.GetName())
...
// is called.
type connectorSystemNetworkinstanceProtocolsEvpn struct {
	log          logging.Logger
	kube         client.Client
...
func (c *connectorSystemNetworkinstanceProtocolsEvpn) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	log := c.log.WithValues("resource", mg.GetName())
	//log.Debug("Connect")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn)
	if !ok {
		return nil, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpn)
	}
	...
	return &externalSystemNetworkinstanceProtocolsEvpn{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) Close() {
	e.client.Close()
}

func (e *externalSystemNetworkinstanceProtocolsEvpn) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Observing ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn)
	if !ok {
		return managed.ExternalObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpn)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpn)
	if !ok {
		return errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpn)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) Delete(ctx context.Context, mg resource.Managed) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Deleting ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) GetTarget() []string {
	return e.targets
}

func (e *externalSystemNetworkinstanceProtocolsEvpn) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalSystemNetworkinstanceProtocolsEvpn) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
