...
const (
	...
	errUpdateNetworkinstanceProtocolsBgp           = "cannot update NetworkinstanceProtocolsBgp"
...
func SetupNetworkinstanceProtocolsBgp(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupNetworkinstanceProtocolsBgp(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.NetworkinstanceProtocolsBgpGroupKind)
	...
	r := managed.NewReconciler(mgr,
		...
		managed.WithValidator(&validatorNetworkinstanceProtocolsBgp{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("NetworkinstanceProtocolsBgp-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	NetworkinstanceProtocolsBgpHandler := &EnqueueRequestForAllNetworkinstanceProtocolsBgp{
	...
	return srlv1alpha1.NetworkinstanceProtocolsBgpGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlNetworkinstanceProtocolsBgp{}).
		Owns(&srlv1alpha1.SrlNetworkinstanceProtocolsBgp{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlNetworkinstanceProtocolsBgp{}}, NetworkinstanceProtocolsBgpHandler).
		Watches(&source.Channel{Source: events}, NetworkinstanceProtocolsBgpHandler).
		Complete(r)
}
...
func initYangNetworkinstanceProtocolsBgp(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
...
func (r *NetworkinstanceProtocolsBgp) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgp)
	if !ok {
...
func (r *NetworkinstanceProtocolsBgp) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
func (v *validatorNetworkinstanceProtocolsBgp) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgp)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedNetworkinstanceProtocolsBgp)
	}
	d, err := json.Marshal(&cr.Spec.NetworkinstanceProtocolsBgp)
	if err != nil {
...
func (c *connectorNetworkinstanceProtocolsBgp) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	return &externalNetworkinstanceProtocolsBgp{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}
...
func (e *externalNetworkinstanceProtocolsBgp) Close() {
	e.client.Close()
}
...
func (e *externalNetworkinstanceProtocolsBgp) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")
...
func (e *externalNetworkinstanceProtocolsBgp) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalNetworkinstanceProtocolsBgp) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalNetworkinstanceProtocolsBgp) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
