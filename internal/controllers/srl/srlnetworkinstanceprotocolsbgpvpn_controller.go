...
const (
	// Errors
	errUnexpectedNetworkinstanceProtocolsBgpvpn       = "the managed resource is not a NetworkinstanceProtocolsBgpvpn resource"
	errKubeUpdateFailedNetworkinstanceProtocolsBgpvpn = "cannot update NetworkinstanceProtocolsBgpvpn"
	errReadNetworkinstanceProtocolsBgpvpn             = "cannot read NetworkinstanceProtocolsBgpvpn"
	errCreateNetworkinstanceProtocolsBgpvpn           = "cannot create NetworkinstanceProtocolsBgpvpn"
	errUpdateNetworkinstanceProtocolsBgpvpn           = "cannot update NetworkinstanceProtocolsBgpvpn"
...
func SetupNetworkinstanceProtocolsBgpvpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupNetworkinstanceProtocolsBgpvpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.NetworkinstanceProtocolsBgpvpnGroupKind)

	events := make(chan cevent.GenericEvent)

	y := initYangNetworkinstanceProtocolsBgpvpn(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.NetworkinstanceProtocolsBgpvpnGroupVersionKind),
		managed.WithPollInterval(nddcopts.Poll),
		managed.WithExternalConnecter(&connectorNetworkinstanceProtocolsBgpvpn{
			log:          nddcopts.Logger,
			kube:         mgr.GetClient(),
		...
		managed.WithValidator(&validatorNetworkinstanceProtocolsBgpvpn{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("NetworkinstanceProtocolsBgpvpn-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	NetworkinstanceProtocolsBgpvpnHandler := &EnqueueRequestForAllNetworkinstanceProtocolsBgpvpn{
	...
	return srlv1alpha1.NetworkinstanceProtocolsBgpvpnGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn{}).
		Owns(&srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn{}}, NetworkinstanceProtocolsBgpvpnHandler).
		Watches(&source.Channel{Source: events}, NetworkinstanceProtocolsBgpvpnHandler).
		Complete(r)
}
...
func initYangNetworkinstanceProtocolsBgpvpn(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &NetworkinstanceProtocolsBgpvpn{&yresource.Resource{
...
func (r *NetworkinstanceProtocolsBgpvpn) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
	if !ok {
...
func (r *NetworkinstanceProtocolsBgpvpn) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
type validatorNetworkinstanceProtocolsBgpvpn struct {
	log          logging.Logger
	deviceSchema *yentry.Entry
	y            yresource.Handler
}

func (v *validatorNetworkinstanceProtocolsBgpvpn) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedNetworkinstanceProtocolsBgpvpn)
	}
	d, err := json.Marshal(&cr.Spec.NetworkinstanceProtocolsBgpvpn)
	if err != nil {
...
func (v *validatorNetworkinstanceProtocolsBgpvpn) ValidateParentDependency(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateParentDependencyObservation, error) {
	log := v.log.WithValues("resource", mg.GetName())
...
func (v *validatorNetworkinstanceProtocolsBgpvpn) ValidateResourceIndexes(ctx context.Context, mg resource.Managed) (managed.ValidateResourceIndexesObservation, error) {
	//log := v.log.WithValues("resource", mg.GetName())
...
// is called.
type connectorNetworkinstanceProtocolsBgpvpn struct {
	log          logging.Logger
	kube         client.Client
...
func (c *connectorNetworkinstanceProtocolsBgpvpn) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	log := c.log.WithValues("resource", mg.GetName())
	//log.Debug("Connect")

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return nil, errors.New(errUnexpectedNetworkinstanceProtocolsBgpvpn)
	}
	...
	return &externalNetworkinstanceProtocolsBgpvpn{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}

// An ExternalClient observes, then either creates, updates, or deletes an
// external resource to ensure it reflects the managed resource's desired state.
type externalNetworkinstanceProtocolsBgpvpn struct {
...
func (e *externalNetworkinstanceProtocolsBgpvpn) Close() {
	e.client.Close()
}

func (e *externalNetworkinstanceProtocolsBgpvpn) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Observing ...")

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return managed.ExternalObservation{}, errors.New(errUnexpectedNetworkinstanceProtocolsBgpvpn)
	}
...
func (e *externalNetworkinstanceProtocolsBgpvpn) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpvpn)
	if !ok {
		return errors.New(errUnexpectedNetworkinstanceProtocolsBgpvpn)
	}
...
func (e *externalNetworkinstanceProtocolsBgpvpn) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalNetworkinstanceProtocolsBgpvpn) Delete(ctx context.Context, mg resource.Managed) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Deleting ...")
...
func (e *externalNetworkinstanceProtocolsBgpvpn) GetTarget() []string {
	return e.targets
}

func (e *externalNetworkinstanceProtocolsBgpvpn) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalNetworkinstanceProtocolsBgpvpn) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
