...
func SetupRoutingpolicyPrefixset(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	...
	RoutingpolicyPrefixsetHandler := &EnqueueRequestForAllRoutingpolicyPrefixset{
	...
	return srlv1alpha1.RoutingpolicyPrefixsetGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlRoutingpolicyPrefixset{}}, RoutingpolicyPrefixsetHandler).
		Watches(&source.Channel{Source: events}, RoutingpolicyPrefixsetHandler).
		Complete(r)
}
...
func initYangRoutingpolicyPrefixset(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
...
func (v *validatorRoutingpolicyPrefixset) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlRoutingpolicyPrefixset)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedRoutingpolicyPrefixset)
	}
...
func (c *connectorRoutingpolicyPrefixset) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlRoutingpolicyPrefixset)
	if !ok {
		return nil, errors.New(errUnexpectedRoutingpolicyPrefixset)
	}
...
func (e *externalRoutingpolicyPrefixset) Close() {
	e.client.Close()
}
...
func (e *externalRoutingpolicyPrefixset) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlRoutingpolicyPrefixset)
	if !ok {
		return errors.New(errUnexpectedRoutingpolicyPrefixset)
	}
...
func (e *externalRoutingpolicyPrefixset) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalRoutingpolicyPrefixset) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
