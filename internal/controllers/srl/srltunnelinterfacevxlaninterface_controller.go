...
const (
	// Errors
	errUnexpectedTunnelinterfaceVxlaninterface       = "the managed resource is not a TunnelinterfaceVxlaninterface resource"
	errKubeUpdateFailedTunnelinterfaceVxlaninterface = "cannot update TunnelinterfaceVxlaninterface"
	errReadTunnelinterfaceVxlaninterface             = "cannot read TunnelinterfaceVxlaninterface"
	errCreateTunnelinterfaceVxlaninterface           = "cannot create TunnelinterfaceVxlaninterface"
	errUpdateTunnelinterfaceVxlaninterface           = "cannot update TunnelinterfaceVxlaninterface"
...
func SetupTunnelinterfaceVxlaninterface(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupTunnelinterfaceVxlaninterface(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.TunnelinterfaceVxlaninterfaceGroupKind)

	events := make(chan cevent.GenericEvent)

	y := initYangTunnelinterfaceVxlaninterface(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.TunnelinterfaceVxlaninterfaceGroupVersionKind),
		managed.WithPollInterval(nddcopts.Poll),
		managed.WithExternalConnecter(&connectorTunnelinterfaceVxlaninterface{
			log:          nddcopts.Logger,
			kube:         mgr.GetClient(),
		...
		managed.WithValidator(&validatorTunnelinterfaceVxlaninterface{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("TunnelinterfaceVxlaninterface-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	TunnelinterfaceVxlaninterfaceHandler := &EnqueueRequestForAllTunnelinterfaceVxlaninterface{
	...
	return srlv1alpha1.TunnelinterfaceVxlaninterfaceGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlTunnelinterfaceVxlaninterface{}).
		Owns(&srlv1alpha1.SrlTunnelinterfaceVxlaninterface{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlTunnelinterfaceVxlaninterface{}}, TunnelinterfaceVxlaninterfaceHandler).
		Watches(&source.Channel{Source: events}, TunnelinterfaceVxlaninterfaceHandler).
		Complete(r)
}
...
func initYangTunnelinterfaceVxlaninterface(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &TunnelinterfaceVxlaninterface{&yresource.Resource{
...
func (r *TunnelinterfaceVxlaninterface) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlTunnelinterfaceVxlaninterface)
	if !ok {
...
func (r *TunnelinterfaceVxlaninterface) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
func (v *validatorTunnelinterfaceVxlaninterface) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlTunnelinterfaceVxlaninterface)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedTunnelinterfaceVxlaninterface)
	}
	d, err := json.Marshal(&cr.Spec.TunnelinterfaceVxlaninterface)
	if err != nil {
...
// is called.
type connectorTunnelinterfaceVxlaninterface struct {
	log          logging.Logger
	kube         client.Client
...
func (c *connectorTunnelinterfaceVxlaninterface) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	log := c.log.WithValues("resource", mg.GetName())
	//log.Debug("Connect")

	cr, ok := mg.(*srlv1alpha1.SrlTunnelinterfaceVxlaninterface)
	if !ok {
		return nil, errors.New(errUnexpectedTunnelinterfaceVxlaninterface)
	}
	...
	return &externalTunnelinterfaceVxlaninterface{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}
...
func (e *externalTunnelinterfaceVxlaninterface) Close() {
	e.client.Close()
}

func (e *externalTunnelinterfaceVxlaninterface) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Observing ...")

	cr, ok := mg.(*srlv1alpha1.SrlTunnelinterfaceVxlaninterface)
	if !ok {
		return managed.ExternalObservation{}, errors.New(errUnexpectedTunnelinterfaceVxlaninterface)
	}
...
func (e *externalTunnelinterfaceVxlaninterface) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlTunnelinterfaceVxlaninterface)
	if !ok {
		return errors.New(errUnexpectedTunnelinterfaceVxlaninterface)
	}
...
func (e *externalTunnelinterfaceVxlaninterface) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalTunnelinterfaceVxlaninterface) Delete(ctx context.Context, mg resource.Managed) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Deleting ...")
...
func (e *externalTunnelinterfaceVxlaninterface) GetTarget() []string {
	return e.targets
}

func (e *externalTunnelinterfaceVxlaninterface) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalTunnelinterfaceVxlaninterface) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
