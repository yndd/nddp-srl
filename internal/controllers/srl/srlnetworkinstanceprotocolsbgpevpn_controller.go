...
func SetupNetworkinstanceProtocolsBgpevpn(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	...
	NetworkinstanceProtocolsBgpevpnHandler := &EnqueueRequestForAllNetworkinstanceProtocolsBgpevpn{
	...
	return srlv1alpha1.NetworkinstanceProtocolsBgpevpnGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlNetworkinstanceProtocolsBgpevpn{}}, NetworkinstanceProtocolsBgpevpnHandler).
		Watches(&source.Channel{Source: events}, NetworkinstanceProtocolsBgpevpnHandler).
		Complete(r)
}
...
func initYangNetworkinstanceProtocolsBgpevpn(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
...
func (v *validatorNetworkinstanceProtocolsBgpevpn) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpevpn)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedNetworkinstanceProtocolsBgpevpn)
	}
...
func (c *connectorNetworkinstanceProtocolsBgpevpn) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpevpn)
	if !ok {
		return nil, errors.New(errUnexpectedNetworkinstanceProtocolsBgpevpn)
	}
...
func (e *externalNetworkinstanceProtocolsBgpevpn) Close() {
	e.client.Close()
}
...
func (e *externalNetworkinstanceProtocolsBgpevpn) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlNetworkinstanceProtocolsBgpevpn)
	if !ok {
		return errors.New(errUnexpectedNetworkinstanceProtocolsBgpevpn)
	}
...
func (e *externalNetworkinstanceProtocolsBgpevpn) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalNetworkinstanceProtocolsBgpevpn) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
