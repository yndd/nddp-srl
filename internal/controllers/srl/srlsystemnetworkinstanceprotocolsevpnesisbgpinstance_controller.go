...
const (
	// Errors
	errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance       = "the managed resource is not a SystemNetworkinstanceProtocolsEvpnEsisBgpinstance resource"
	errKubeUpdateFailedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance = "cannot update SystemNetworkinstanceProtocolsEvpnEsisBgpinstance"
	errReadSystemNetworkinstanceProtocolsEvpnEsisBgpinstance             = "cannot read SystemNetworkinstanceProtocolsEvpnEsisBgpinstance"
	...
	errUpdateSystemNetworkinstanceProtocolsEvpnEsisBgpinstance           = "cannot update SystemNetworkinstanceProtocolsEvpnEsisBgpinstance"
...
func SetupSystemNetworkinstanceProtocolsEvpnEsisBgpinstance(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) (string, chan cevent.GenericEvent, error) {
	//func SetupSystemNetworkinstanceProtocolsEvpnEsisBgpinstance(mgr ctrl.Manager, o controller.Options, nddcopts *shared.NddControllerOptions) error {

	name := managed.ControllerName(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceGroupKind)

	events := make(chan cevent.GenericEvent)

	y := initYangSystemNetworkinstanceProtocolsEvpnEsisBgpinstance(
		nddcopts.DeviceSchema,
	)

	r := managed.NewReconciler(mgr,
		resource.ManagedKind(srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceGroupVersionKind),
		managed.WithPollInterval(nddcopts.Poll),
		managed.WithExternalConnecter(&connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{
			log:          nddcopts.Logger,
			kube:         mgr.GetClient(),
		...
		managed.WithValidator(&validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{
			log:          nddcopts.Logger,
			deviceSchema: nddcopts.DeviceSchema,
			y:            y},
		),
		managed.WithLogger(nddcopts.Logger.WithValues("SystemNetworkinstanceProtocolsEvpnEsisBgpinstance-controller", name)),
		managed.WithRecorder(event.NewAPIRecorder(mgr.GetEventRecorderFor(name))))

	SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceHandler := &EnqueueRequestForAllSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{
	...
	return srlv1alpha1.SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceGroupKind, events, ctrl.NewControllerManagedBy(mgr).
		Named(name).
		WithOptions(o).
		For(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{}).
		Owns(&srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{}).
		...
		*/
		Watches(&source.Kind{Type: &srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{}}, SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceHandler).
		Watches(&source.Channel{Source: events}, SystemNetworkinstanceProtocolsEvpnEsisBgpinstanceHandler).
		Complete(r)
}
...
func initYangSystemNetworkinstanceProtocolsEvpnEsisBgpinstance(deviceSchema *yentry.Entry, opts ...yresource.Option) yresource.Handler {
	return &SystemNetworkinstanceProtocolsEvpnEsisBgpinstance{&yresource.Resource{
...
func (r *SystemNetworkinstanceProtocolsEvpnEsisBgpinstance) GetRootPath(mg resource.Managed) []*gnmi.Path {

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if !ok {
...
func (r *SystemNetworkinstanceProtocolsEvpnEsisBgpinstance) GetParentDependency(mg resource.Managed) []*leafref.LeafRef {
...
type validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance struct {
	log          logging.Logger
	deviceSchema *yentry.Entry
	y            yresource.Handler
}

func (v *validatorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) ValidateLeafRef(ctx context.Context, mg resource.Managed, cfg []byte) (managed.ValidateLeafRefObservation, error) {
	...
	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if !ok {
		return managed.ValidateLeafRefObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	}
	d, err := json.Marshal(&cr.Spec.SystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if err != nil {
...
// is called.
type connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance struct {
	log          logging.Logger
	kube         client.Client
...
func (c *connectorSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Connect(ctx context.Context, mg resource.Managed) (managed.ExternalClient, error) {
	log := c.log.WithValues("resource", mg.GetName())
	//log.Debug("Connect")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if !ok {
		return nil, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	}
	...
	return &externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance{client: cl, targets: tns, log: log, deviceSchema: c.deviceSchema, nddpSchema: c.nddpSchema, y: c.y}, nil
}

// An ExternalClient observes, then either creates, updates, or deletes an
// external resource to ensure it reflects the managed resource's desired state.
type externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance struct {
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Close() {
	e.client.Close()
}

func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Observe(ctx context.Context, mg resource.Managed) (managed.ExternalObservation, error) {
	log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Observing ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if !ok {
		return managed.ExternalObservation{}, errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Create(ctx context.Context, mg resource.Managed, ignoreTransaction bool) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Creating ...")

	cr, ok := mg.(*srlv1alpha1.SrlSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	if !ok {
		return errors.New(errUnexpectedSystemNetworkinstanceProtocolsEvpnEsisBgpinstance)
	}
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Update(ctx context.Context, mg resource.Managed, obs managed.ExternalObservation) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Updating ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) Delete(ctx context.Context, mg resource.Managed) error {
	//log := e.log.WithValues("Resource", mg.GetName())
	//log.Debug("Deleting ...")
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) GetTarget() []string {
	return e.targets
}

func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) GetConfig(ctx context.Context, mg resource.Managed) ([]byte, error) {
...
func (e *externalSystemNetworkinstanceProtocolsEvpnEsisBgpinstance) GetResourceName(ctx context.Context, mg resource.Managed, path *gnmi.Path) (string, error) {
