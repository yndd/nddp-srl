...
func initNetworkinstanceTepoliciesStaticpolicySegmentlist(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"segment": initNetworkinstanceTepoliciesStaticpolicySegmentlistSegment,
	}
	e := &yentry.Entry{
		Name: "segment-list",
		Key: []string{
