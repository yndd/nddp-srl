...
func initNetworkinstanceProtocolsIsisInstanceInterfaceSegmentroutingMplsStaticadjacencysid(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "static-adjacency-sid",
		Key:              []string{},
		Module:           "",
		Namespace:        "",
