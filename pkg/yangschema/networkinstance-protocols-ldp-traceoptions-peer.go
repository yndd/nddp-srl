...
func initNetworkinstanceProtocolsLdpTraceoptionsPeer(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
		...
		LeafRefs: []*leafref.LeafRef{
			{
				...
				RemotePath: &gnmi.Path{
					Elem: []*gnmi.PathElem{
						...
						{Name: "ldp"},
						{Name: "peers"},
						{Name: "peer", Key: map[string]string{"label-space-id": ""}},
					},
				},
			},
			{
