...
func initNetworkinstanceProtocolsLdpDiscoveryInterfacesInterfaceIpv4StatisticsHellomessageerrors(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{}
	e := &yentry.Entry{
		Name:             "hello-message-errors",
		Key:              []string{},
		Parent:           p,
