...
func initNetworkinstanceTepoliciesStaticpolicy(p *yentry.Entry, opts ...yentry.EntryOption) *yentry.Entry {
	children := map[string]yentry.EntryInitFunc{
		"segment-list": initNetworkinstanceTepoliciesStaticpolicySegmentlist,
	}
	e := &yentry.Entry{
		Name: "static-policy",
		Key: []string{
